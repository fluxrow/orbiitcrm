-- ROLLBACK de 20260911124500_viver_campaign_slot_atomic_reservation.sql
-- Restaura a definição ANTERIOR de outbox_claim_batch (idêntica à de
-- 20260902082450_repair_essential_flow_delivery_window.sql) e remove a função
-- nova. Advisory locks são transacionais: nada de estado ou dados a reverter.

DROP FUNCTION IF EXISTS public.viver_campaign_slot_try_acquire(uuid, uuid, integer, integer);
