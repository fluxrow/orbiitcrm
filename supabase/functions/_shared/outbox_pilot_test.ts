...
Deno.test("pilot only admits explicitly marked controlled Viver operations to evidence checks", () => {
  ...
  assertEquals(
    pilotStaticBlockReason({
      ...
      metadata: {
        ...
        pilot_not_before: "2026-08-29T03:00:00Z",
      },
    }),
    null,
  );
  assertEquals(
    pilotStaticBlockReason({
      ...
      metadata: {
        meeting_id: "11111111-1111-4111-8111-111111111111",
        reminder_kind: "meeting_reminder_5m",
      },
    }),
    null,
  );
  assertEquals(
    pilotStaticBlockReason({
      ...
      metadata: {
        meeting_id: "11111111-1111-4111-8111-111111111111",
        reminder_kind: "meeting_reschedule_notice",
      },
    }),
    null,
  );
  assertEquals(
    pilotStaticBlockReason({
      ...
      metadata: {
        meeting_id: "11111111-1111-4111-8111-111111111111",
        reminder_kind: "arbitrary_bypass",
      },
    }),
    PILOT_SOURCE_BLOCKED,
  );
  ...
  assertEquals(PILOT_FOLLOWUP_STALE_BACKLOG, "PILOT_FOLLOWUP_STALE_BACKLOG");
  assertEquals(
    PILOT_MEETING_EVIDENCE_REQUIRED,
    "PILOT_MEETING_EVIDENCE_REQUIRED",
  );
...
Deno.test("pilot permits only the explicitly marked Viver Typebot D0 action", () => {
  assertEquals(
    pilotStaticBlockReason({
      ...
      metadata: {
        viver_pilot_typebot_d0: true,
        pilot_not_before: "2026-08-19T20:30:00Z",
      },
    }),
    null,
  );
